...
public class KafkaChannelConfiguration {
  ...
  public static final boolean DEFAULT_PARSE_AS_FLUME_EVENT = false;
  ...
  // flume event headers
  public static final boolean DEFAULT_SET_HEADER = false;

  public static final String SET_TOPIC_HEADER = "setTopicHeader";
  public static final String TOPIC_HEADER_KEY = "topicHeader";
  public static final String DEFAULT_TOPIC_HEADER = "topic";

  public static final String SET_PARTITION_HEADER = "setPartitionHeader";
  public static final String PARTITION_HEADER_KEY = "partitionHeader";
  public static final String DEFAULT_PARTITION_HEADER = "partition";

  public static final String SET_OFFSET_HEADER = "setOffsetHeader";
  public static final String OFFSET_HEADER_KEY = "offsetHeader";
  public static final String DEFAULT_OFFSET_HEADER = "offset";

  // channel mode source or sink, default source mode
  public static final String USE_SINK_MODE = "useSinkMode";
}
